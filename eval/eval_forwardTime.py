...
from erfnet_pspnet_hier42_nobn import Net
...
def main(args):
    ...
    #for step, (images, labels, filename, filenameGt) in enumerate(loader):
        ...
        if i!=0:    #first run always takes some time for setup
            ...
            print ("Forward time per img (b=%d): %.4f (Mean: %.4f)" % (args.batch_size, fwt/args.batch_size, sum(time_train) / len(time_train) / args.batch_size))
